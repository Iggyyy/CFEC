...
from ..constraints import ValueMonotonicity, Freeze, OneHot, ValueNominal
...
def _count_difference_number(df: pd.DataFrame, constraints: Optional[List[Any]] = None) -> List[np.float64]:
